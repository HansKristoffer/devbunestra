...
import { postgresDockerService, type PostgresServiceOptions } from "./postgres";
import { redisDockerService, type RedisServiceOptions } from "./redis";
...
export type CustomServiceOptions = ServiceConfig & { docker: DockerComposeServiceRaw };
...
export function inferDockerPreset(serviceKey: string): DockerPresetName | undefined {
